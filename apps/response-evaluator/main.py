...
FastAPI server for evaluating individual AI model responses against regulatory scenarios
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    print("\n>> Response Evaluator Service starting...")
...
# Create FastAPI app
app = FastAPI(
    title="Response Evaluator Service",
    description="Evaluates individual AI model responses against regulatory scenarios",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    ...
    return {
        "service": "Response Evaluator Service",
        "version": "1.0.0",
        "status": "running",
